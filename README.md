...
3. `cover-letter-review`로 **문항별 리뷰**
4. 필요할 때만 전체 자소서 단위로 정합성 점검

품질 우선 기준에서는 전체 자소서를 한 번에 처리하는 것보다, **문항별 초안 작성과 문항별 리뷰를 적용했을 때 결과물이 더 좋아집니다.**
문항마다 평가 의도와 강조 포인트가 다르기 때문입니다. 전체 일괄 작성/리뷰는 속도는 빠르지만, 보통 빠른 초안 또는 마지막 정합성 확인용으로 적합합니다.
